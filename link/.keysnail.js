...
key.setCaretKey('z', function (ev) {
                command.recenter(ev);
            }, 'Scroll to the cursor position', true);
...
key.setViewKey('e', function (aEvent, aArg) {
			...
			}, 'Start Hit a Hint in foreground', true);

key.setViewKey('E', function (aEvent, aArg) {
		    ext.exec("hok-start-background-mode", aArg);
			}, 'Start Hit a hint in background', true);

key.setViewKey(';', function (aEvent, aArg) {
		    ext.exec("hok-start-extended-mode", aArg);
			}, 'HoK - extended hint mode', true);

key.setViewKey(['C-c', 'C-e'], function (aEvent, aArg) {
		    ext.exec("hok-start-continuous-mode", aArg);
			}, 'Start Hit a hint - Open link continuous', true);
